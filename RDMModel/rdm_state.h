...
class RDM_MODEL_API State_t {
public:
    State_t();

    struct RDM_MODEL_API Statics_t {
        Statics_t();
    ...
    struct RDM_MODEL_API CastState_t {
        CastState_t();
    ...
    enum RDM_MODEL_API MeleeCombo_t {
        MELEE_RIPOSTE,
        MELEE_ZWER,
        MELEE_REDOUBLEMENT,
        MELEE_FINISHER,
